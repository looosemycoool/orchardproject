...
class Planner(models.Model):
    ...
    todo1_content = models.CharField(max_length=30, blank=True, null=True)
    todo2_subject = models.CharField(max_length=10, blank=True, null=True)
    todo2_content = models.CharField(max_length=30, blank=True, null=True)
    todo3_subject = models.CharField(max_length=10, blank=True, null=True)
    todo3_content = models.CharField(max_length=30, blank=True, null=True)
    todo4_subject = models.CharField(max_length=10, blank=True, null=True)
    todo4_content = models.CharField(max_length=30, blank=True, null=True)
    todo5_subject = models.CharField(max_length=10, blank=True, null=True)
    todo5_content = models.CharField(max_length=30, blank=True, null=True)
    todo6_subject = models.CharField(max_length=10, blank=True, null=True)
    todo6_content = models.CharField(max_length=30, blank=True, null=True)
    todo7_subject = models.CharField(max_length=10, blank=True, null=True)
    todo7_content = models.CharField(max_length=30, blank=True, null=True)
    todo8_subject = models.CharField(max_length=10, blank=True, null=True)
    todo8_content = models.CharField(max_length=30, blank=True, null=True)
    todo9_subject = models.CharField(max_length=10, blank=True, null=True)
    todo9_content = models.CharField(max_length=30, blank=True, null=True)
    todo10_subject = models.CharField(max_length=10, blank=True, null=True)
    todo10_content = models.CharField(max_length=30, blank=True, null=True)
