...
def index(request):
    patrol_weekly_data_week_name = Patrol_Weekly_Data.objects.values('week_name').order_by('id').distinct()
    patrol_dates = Patrol_Data.objects.values('date').order_by('id').distinct()
