...
def index(request):
    ...
    if request.method == 'POST':
        ...
        selected_class = request.POST.get('class_button')

        return redirect('check:detail',  selected_class, selected_date)
...
def update_attendance(request, attendance_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('check:detail', attendance.user.class_name, attendance.date)
